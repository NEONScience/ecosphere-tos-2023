...
# examination of other data fields; ABBY records are mis-indentified by the function as 'dups'
...
plotsGraph <- ggplot2::ggplot(
  ...
  ggplot2::labs(
    ...
    title = "Figure 1. Correlation between CDW Volume and Max Small Mammal Abundance
...
sitePlotsGraph <- ggplot2::ggplot(
  ...
  ggplot2::labs(
    x = "CDW Volume (m3/ha)",
    y = "Max Small Mammal Abundance (count/ha)",
    title = "Figure 2. Correlation between CDW Volume and Max Small Mammal Abundance
    by plot within site."
  )
...
Code was developed and tested using `R v4.1.2` and key packages with versions as shown below.
