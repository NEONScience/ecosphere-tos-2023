...
DT::datatable(
  ...
  caption = "CDW volume density estimates by plotID for selected sites and eventIDs. The 'Plot subtype' column indicates whether a given CDW plot is colocated with a Small Mammal sampling grid."
)
