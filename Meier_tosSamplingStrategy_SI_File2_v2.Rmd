---
title: "Meier et al. (2022) Ecosphere - Supporting Information File 2: Example linking NEON TOS Coarse Downed Wood volume and Small Mammal abundance data at plot and site scales"
...
Code was developed and tested using `R v4.2.1`, and key packages with versions as shown below. Worked example code may generate errors if key package versions differ from those indicated. Source code is available via GitHub: https://github.com/NEONScience/ecosphere-tos-2022
