...
###-->  Could delete this since possible to identify collocation by simple plotID joining (done in code below) --------------------->
...
### Second, check the mam_pertrapnight table by nightuid and trapcoordinate using the standard neonOS::removeDups() function. Note that RELEASE 2022 contains ~142K records for theSites downloaded, so this operation can take some time.
